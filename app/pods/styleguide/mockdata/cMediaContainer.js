const cMediaContainer = {
  ...
  medias2: [
    {
      altText: 'example image xxs',
      url: 'http://via.placeholder.com/300x300/FF0000?text=Example-XXS',
      mediaFormat: 'imageXXS'
    },
    {
      altText: 'example image xs',
      url: 'http://via.placeholder.com/400x400/FF0000?text=Example-XS',
      mediaFormat: 'imageXS'
    },
    {
      altText: 'example image sm',
      url: 'http://via.placeholder.com/500x500/FF0000?text=Example-SM',
      mediaFormat: 'imageSM'
    },
    {
      altText: 'example image md',
      url: 'http://via.placeholder.com/600x600/FF0000?text=Example-MD',
      mediaFormat: 'imageMD'
    },
    {
      altText: 'example image lg',
      url: 'http://via.placeholder.com/700x700/FF0000?text=Example-LG',
      mediaFormat: 'imageLG'
    },
    {
      altText: 'example image xl',
      url: 'http://via.placeholder.com/800x800/FF0000?text=Example-XL',
      mediaFormat: 'imageXL'
    },
    {
      altText: 'example image xxs retina',
      url: 'http://via.placeholder.com/300x300/FF0000?text=Example-XXS-Retina',
      mediaFormat: 'imageXXSRetina'
    },
    {
      altText: 'example image xs Retina',
      url: 'http://via.placeholder.com/400x400/FF0000?text=Example-XS-Retina',
      mediaFormat: 'imageXSRetina'
    },
    {
      altText: 'example image sm Retina',
      url: 'http://via.placeholder.com/500x500/FF0000?text=Example-SM-Retina',
      mediaFormat: 'imageSMRetina'
    },
    {
      altText: 'example image md Retina',
      url: 'http://via.placeholder.com/600x600/FF0000?text=Example-MD-Retina',
      mediaFormat: 'imageMDRetina'
    },
    {
      altText: 'example image lg Retina',
      url: 'http://via.placeholder.com/700x700/FF0000?text=Example-LG-Retina',
      mediaFormat: 'imageLGRetina'
    },
    {
      altText: 'example image xl Retina',
      url: 'http://via.placeholder.com/800x800/FF0000?text=Example-XL-Retina',
      mediaFormat: 'imageXLRetina'
    }
  ]
};
